...
function SiteInfo ({ title }) {
  ...
  return (
        ...
        >
            ...
            <br />
            <span className='text-xs font-serif'> Powered by <a href='https://space.bilibili.com/672353429/' className='underline text-gray-500 dark:text-gray-300'>LOVE</a></span><br /></span>
            <h1>{title}</h1>
        </footer>
  )
}
