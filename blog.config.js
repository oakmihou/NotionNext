...
const BLOG = {
  AUTHOR: 'mihou', // 作者
  BIO: '摔倒了爬起来就好', // 作者简介
  LINK: 'https://wukoo.asia', // 网站地址
  KEYWORDS: 'Notion, mihou, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '8d811e1e3c754153b2306cfe59921e5c', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  BACKGROUND_LIGHT: '#FAF0E6', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#282C34', // use hex value, don't forget '#'
  ...
  CONTACT_EMAIL: 'to.coldle@outlook.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
